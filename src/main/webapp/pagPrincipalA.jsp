...
<html>
    <head>
        ...
        <link href="Css/principalA.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="Javascript/principalAjs.js"></script>
    </head>
    <body>
        <style>
            .dropdown .btn {
        ...
        <div class="sidebar-left">
            ...
            <ul>                
                <li><a href="pagGestionUsuarios.jsp" target="main-iframe" onclick="collapseServices()"><i class="fas fa-user"></i> Gestión Usuarios</a></li>
